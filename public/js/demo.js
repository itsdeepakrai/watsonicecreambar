...
$(document).ready(function() {
    ...
    if (userhash !== "" && userhash != false && userhash != "@false") {
    	userhash = '@'+userhash;
    ...
    function handleRequest(userhash) {
        ...
        //dynamically adding text in tweet
        
        
        
      
        var name=$("#userhash").val();
        var text="This is cool ! #IBMWatson analyzed my twitter profile "+name+"  at #NASSCOM_ILF . Try it now"
    ...
    var tweetBtn = $('<a></a>')
        ...
        .attr('data-url', 'http://watsonicecreambar.mybluemix.net/')
        .attr('data-text', text)
        ...
        for (var i = 0; i < traitList.length; i++) {
            ...
            if (elem.value !== '') { // Trait child name
                $('#trait-template').clone()
                    ...
                    if(elem.id=="Adventurousness"){
                        
                        var success =elem.value.replace('%', '');
                        d1="Thanks for checking us out."
                        d2="Based on the data collected from the tweets and using personality insights.We are guessing you may like  "
                            
                        if(success>75){
                            
                             
                            d4="Thank you. Based on an analysis of your Twitter feed using the Watson Personality Insights service, we are guessing you may like the Black Current Sundae Spin flavour!"
                            
                        }else if(success>50){
                            
                             d4="Thank you. Based on an analysis of your Twitter feed using the Watson Personality Insights service, we are guessing you may like the Pistachioe Almond Fudge flavour!"
                        }else if(success>25){
                            
                             d4="Thank you. Based on an analysis of your Twitter feed using the Watson Personality Insights service, we are guessing you may like the Kool Gulab flavour!"
                        }else{
                            
                            d4="Thank you. Based on an analysis of your Twitter feed using the Watson Personality Insights service, we are guessing you may like the Shahi Anjeer flavour!"
                        }
    ...
    function showTextSummary(data) {
       ...
       /* var paragraphs = [
        ...
        console.log('showTextSummary()'+paragraphs);
